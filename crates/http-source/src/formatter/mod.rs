...
use http_json_record::HttpJsonRecord;
use http_response_record::HttpResponseRecord;
...
// pub enum Formatter {
//     // For formatting responses as they are polled for
//     ResponseFormatter(ResponseFormatter),

//     // For formatting chunks of a single streamed response
//     StreamFormatter(StreamFormatter),
// }

// impl Formatter {
//     pub fn response_formatter(
//         output_type: OutputType,
//         output_parts: OutputParts,
//     ) -> Self {
//         Self::ResponseFormatter(ResponseFormatter::new(
//             output_type,
//             output_parts,
//         ))
//     }

//     pub fn stream_formatter(
//         response: Response,
//         output_type: OutputType,
//         output_parts: OutputParts,
//     ) -> Self {
//         Self::StreamFormatter(StreamFormatter::new(
//             response,
//             output_type,
//             output_parts,
//         ))
